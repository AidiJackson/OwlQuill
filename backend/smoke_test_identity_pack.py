...
CHARACTERS = [
    {
        "label": "C1 · Human woman · realistic · navy blazer",
        ...
        "spec":  {
            ...
            "wardrobe": {"outfit_type": "blazer", "primary_color": "navy",
                         "secondary_color": "white", "footwear": "heels"},
        },
    },
    {
        "label": "C2 · Human man · realistic · denim jacket",
        ...
        "spec":  {
            ...
            "wardrobe": {"outfit_type": "denim jacket", "primary_color": "indigo",
                         "accessory": "leather watch"},
        },
    },
    {
        "label": "C3 · Fantasy elf · realistic · forest cloak",
        "char":  {"name": "Sylara", "species": "elf"},
        "spec":  {
            "style": "realistic",
            "identity": {"hair_color": "silver", "hair_length": "long",
                         "eye_color": "violet", "skin_tone": "pale"},
            "wardrobe": {"outfit_type": "hooded cloak", "primary_color": "forest green"},
            "build": {"body_type": "slender", "height_band": "tall"},
        },
    },
    {
        "label": "C4 · Anime style · colourful outfit",
        "char":  {"name": "Hana Kira", "species": "human"},
        "spec":  {
            "style": "anime",
            "identity": {"hair_color": "pink", "hair_length": "twin-tails",
                         "eye_color": "amber"},
            "wardrobe": {"outfit_type": "sailor uniform", "primary_color": "white",
                         "secondary_color": "red"},
        },
    },
    {
        "label": "C5 · Human woman · no wardrobe spec",
