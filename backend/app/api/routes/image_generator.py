...
# ── Cover generation prompt prefix ───────────────────────────────────
# Prepended when generate_cover=True to guide the provider toward a
# wide cinematic banner composition suitable for profile cover banners.
