...
cover images generated via the image generator can be stored distinctly
from regular 'generated' character images.
"""
...
def downgrade() -> None:
    ...
    # A full enum recreation would be needed; omitted as the value is harmless.
    pass
