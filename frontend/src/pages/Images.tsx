...
export default function Images() {
  ...
  // The user's characters for the generator and cover-assignment selectors
  ...
  // Cover-assignment state (kind="cover" images only)
  ...
  // Drive lightbox enter/exit transition
  useEffect(() => {
  ...
  // Characters tab: regular generated scene images only
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {generatedCoverImages.map((img) => (
                  <button
                    ...
                    className="rounded-lg border border-gray-800 overflow-hidden bg-gray-900 hover:border-gray-600 transition-colors cursor-pointer text-left"
                    onClick={() => openLightbox(img.url, img)}
                    title="Click to assign as character cover"
                  >
                    <img
                      src={img.url}
          ...
          >
            ...
            {lightboxCharImage && (
              <div className="mt-2 space-y-2">
                {/* Set as cover — only for kind="cover" images */}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <button
                        ...
                        disabled={applyingCover || !coverTargetCharId}
