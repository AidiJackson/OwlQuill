                    ...
                    {comment.character_name ? (
                      <div className="flex items-center gap-1 flex-shrink-0">
                        {comment.character_avatar_url ? (
                          ...
                          <div className="w-6 h-6 rounded bg-emerald-600/20 border border-emerald-500/20 flex items-center justify-center text-[10px] font-semibold text-emerald-400 flex-shrink-0">
